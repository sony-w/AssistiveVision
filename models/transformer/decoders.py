...
from models.transformer.containers import Module, ModuleList
...
class MeshedDecoder(Module):
    def __init__(self, vocab_size, max_len, N_dec, padding_idx, d_model=512, d_k=64, d_v=64, h=8, d_ff=2048, dropout=.1,
        ...
        encoding_table = sinusoid_encoding_table(max_len + 1, d_model, 0)
        self.pos_emb = nn.Embedding.from_pretrained(encoding_table, freeze=True)
